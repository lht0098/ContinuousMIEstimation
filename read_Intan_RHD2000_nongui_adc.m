...
%% THIS IS A HACK TO AVOID APPLYING THE NOTCH FILTER WHEN ONLY LOADING ADC DATA
notch_filter_frequency = 0;
% END OF HACK
...
if (data_present)
    ...
    if verbose > 2; fprintf(1, 'Allocating memory for data...\n'); end
    ...
    if verbose > 1; fprintf(1, 'Reading data from file...\n'); end
...
if (data_present)
    ...
    if verbose > 2; fprintf(1, 'Parsing data...\n'); end
    ...
    if (notch_filter_frequency > 0)
        if verbose > 1; fprintf(1, 'Applying notch filter...\n'); end
