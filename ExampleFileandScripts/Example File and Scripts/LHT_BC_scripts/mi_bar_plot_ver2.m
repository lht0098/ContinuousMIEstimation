...
sigs = {'sig0_', 'sig00001_', 'sig0005_', 'sig002_', 'sig05_', 'sig15_', 'sig30_', 'sig60_', 'sig90_', 'sig900_', 'sig1800_'};  
...
% List of all possible sigma values 
sigs_label = {'0', '0.0001', '0.005', '0.02', '0.5', '1.5', '30', '60', '90', '900', '1800'};  
...
title([units_title ' ' pairs_title])
xticklabels(sigs_label)
xlabel('\sigma (s)')
